...
const Services = () => {
  ...
  return <section id="services" className="section py-24 bg-[#0A0A14]">
      <div className="container-tight">
        <div className="mb-20 text-center">
          ...
          <motion.h2 className="text-4xl md:text-6xl font-bold mb-6 text-white" initial={{
          opacity: 0,
          y: 20
        }} whileInView={{
          opacity: 1,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviceItems.map((service, index) => <motion.div key={index} initial={{
          opacity: 0,
          y: 30
        }} whileInView={{
          opacity: 1,
          ...
          delay: 0.1 * index
              ...
              <Card className={`relative overflow-hidden bg-[#151528] border-0 h-full group transition-all duration-500 hover:shadow-xl hover:shadow-[#7928CA]/20 ${hoveredIndex === index ? 'scale-105' : ''}`} onMouseEnter={() => setHoveredIndex(index)} onMouseLeave={() => setHoveredIndex(null)}>
