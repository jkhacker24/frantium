...
const Contact = () => {
  ...
  return <section id="contact" className="section bg-gradient-to-br from-agency-blue to-black text-white">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300"> frantium.universe24@gmail.com</p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg p-8">
              ...
              <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                  ...
                  <Button type="submit" className="w-full bg-agency-teal hover:bg-opacity-90 text-white">
                    Send Message
                  </Button>
                </form>
              </Form>
