...
const Hero = () => {
  ...
  return <section className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-gradient-to-br from-[#0A0A14] to-[#1F1346]">
      <canvas ref={canvasRef} className="absolute top-0 left-0 w-full h-full z-0" />
      
      <div className="container-tight relative z-10 flex flex-col items-center text-center bg-gray-950">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-8 text-white leading-tight" style={{
        ...
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mb-10 leading-relaxed" style={{
        ...
        <div className="flex flex-col sm:flex-row gap-6 mt-4" style={{
        animation: 'fade-in 0.8s ease-out 0.5s both'
      }}>
          <Button size="lg" className="bg-gradient-to-r from-[#7928CA] to-[#FF0080] hover:opacity-90 transition-all text-lg px-8 py-6 font-extrabold text-slate-50">
            See Our Portfolio
          </Button>
          <Button variant="outline" size="lg" className="border-2 border-white/30 hover:bg-white/10 text-lg px-8 py-6 text-zinc-50">
            Get Free Quote
          </Button>
        </div>
        
        <button onClick={scrollToServices} className="absolute bottom-10 left-1/2 transform -translate-x-1/2 bg-white/10 backdrop-blur-sm p-3 rounded-full border border-white/20 animate-bounce mt-16 group" aria-label="Scroll down">
